...
export default {
  ...
  created() {
    this.initIncomeStatusList("6");
    this.initIncomeTypeList("10");
    this.initCardList();
  ...
  methods: {
    ...
    initCardList() {
      this.axios({
        ...
        this.form.cardIdIncome = this.cardList[0].id;
      });
    },
    initSupplireList() {
      this.axios({
    ...
    initIncomeTypeList(status) {
      this.axios({
        ...
        this.form.type = this.incometypeList[0].id;
      });
    },
    initIncomeStatusList(level) {
      this.axios({
        method: "post",
        url: "/myoa/smbus/dic/dic/selectDicInType",
        data: {
        ...
        this.form.status = this.incomeStatusList[0].id;
      });
    },
    onSubmit() {
      this.addIncomeRecode();
      this.cancelButton();
    },
    addIncomeRecode() {
      this.axios({
        method: "post",
        url: "/myoa/smbus/incomeRecode/saveIncomeRecode",
        data: {
          data: {
